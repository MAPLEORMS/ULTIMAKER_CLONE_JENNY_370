...
#define PRINTER_NAME "RMS-370"  // Change this to whatever you wish, or leave it as it is.
 ...
 */
#define E0_STEPS      386.6 // Stock extruder. If you have a Tevo Titan, try 400 then calibrate.
...
#define STRING_CONFIG_H_AUTHOR "(MITUL, RMS-370)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  12.91,  12.91 }
    #define DEFAULT_Ki_LIST {   0.84,   0.84 }
    #define DEFAULT_Kd_LIST { 49.43, 49.43 }
  #else
...
//#if DISABLED(ENDSTOPPULLUPS)
  ...
  //#define ENDSTOPPULLUP_KMAX4#endif
 ...
 */
#if ENABLED(DUAL_EXTRUDER)
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, E0_STEPS, E1_STEPS }
#else
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, E0_STEPS }
#endif
...
#define MANUAL_Z_HOME_POS 370 // Distance between the nozzle to printbed after homing
